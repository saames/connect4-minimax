...
TABELA_JOGADOR_COMECA = [
    [4,  5,  7,  9,  7,  5, 4], # Índice 0 (Linha 6 - Par): Pesos aumentados
    [3,  4,  6,  8,  6,  4, 3], # Índice 1 (Linha 5 - Ímpar): Pesos reduzidos
    [7, 10, 13, 15, 13, 10, 7],# Índice 2 (Linha 4 - Par): Pesos fortemente aumentados
    [4,  6,  9, 18,  9,  6, 4], # Índice 3 (Linha 3 - Ímpar): D3 (coluna 3) é a exceção vital com peso 18
    [5,  8, 11, 13, 11,  8, 5], # Índice 4 (Linha 2 - Par): Pesos aumentados
    [3,  4, 10,  5, 10,  4, 3]  # Índice 5 (Linha 1 - Ímpar): C1 (col 2) e E1 (col 4) inflados para cercar D1
]
...
def iniciar_jogo():
    ...
    if turno:
        TABELA_PESOS = TABELA_IA_COMECA
    else:
        TABELA_PESOS = TABELA_JOGADOR_COMECA
